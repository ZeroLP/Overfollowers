...
<html>
   ...
   <body bgcolor = "#FFFFFF">
    ...
    <h2 class="form-signup-heading" style="color: white;">Update PFP</h2>

    <form class="form-addaccount" id="editaccform" action="../uploads.php" method="POST" enctype="multipart/form-data">

        <input type="file" name="file" id="file" required>
        <div style="margin-bottom: 10px">
</div>
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Update PFP</button>
      </form>
</div>
</div> <!-- /container -->
