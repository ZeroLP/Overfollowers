...
<html>
   ...
   <body bgcolor = "#FFFFFF">
    ...
    <h2 class="form-signup-heading" style="color: white;">Edit Account</h2>

    <form class="form-addaccount" id="editaccform" action="includes/editacc.inc.php" method="POST">
 ...
 <label for="inputln" class="sr-only">Account Description</label>
        <textarea name="desc" form="editaccform" placeholder="Account Description" required style="padding: 5px; border-radius: 5px"></textarea>
        <div style="margin-bottom: 10px">
        </div>
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Edit Account</button>
      </form>
</div>
</div> <!-- /container -->
