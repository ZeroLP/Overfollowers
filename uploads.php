    ...
    if (in_array($fileActualExt, $allowed)) {
      ...
      if ($fileError === 0) {
        ...
        if ($fileSize < 10000) {
          ...
          $fileNameNew = "$accid".".".uniqid('', true).".".$fileActualExt;
          //Here we define where we want the new file uploaded to
          $fileDestination = 'accpfp/'.$fileNameNew;
          ...
          $sql = "UPDATE accounts SET account_img='$fileNameNew' WHERE account_id='$accid';";
          
          mysqli_query($db, $sql);
          header("Location: ../dashboard.php?successful");
          exit(); #stops the script after this line - same as return;
            ...
            echo "Files too big! Maximum: 10MB";
            exit();
        }
      }
      else { 
      ...
      echo "File is not an JPG, JPEG or a PNG format!";
            exit();
    }
  }